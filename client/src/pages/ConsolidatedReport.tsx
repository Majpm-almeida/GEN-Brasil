...
export default function ConsolidatedReport() {
  ...
  const downloadPdf = async () => {
    ...
    try {
      await downloadGroupReportPdf(workspace, selectedWorksheetLenses);
