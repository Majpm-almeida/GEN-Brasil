# Verificação visual — Base pré-carregada

- A tela **Base do caso** mantém a navegação por eventos e agora mostra o conteúdo integral de **Informação disponível** e **Limite da evidência** no painel selecionado.
- O botão **DESCRIÇÃO COMPLETA** abre uma janela interna com rolagem, título do Caso Único da Semana, os quatro parágrafos do contexto estratégico, a conjuntura de atores reais, o quadro funcional brasileiro e os atores fictícios.
- A apresentação foi conferida no ambiente de desenvolvimento autenticado em 30 de agosto de 2026.
